...
$result = mysqli_query($mysqli, "SELECT * FROM tbl_data_penanganan ORDER BY npa DESC");
...
<div style ="color: white; font-family:Zapf-Chancery; font-size: 22px;
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <h4></h4>
        <form action="tampil_penanganan.php" method="POST">
          <center>
...
<center>
   <tr>
        <th>No</th> <th>Npa</th> <th>Nama</th> <th>Alamat</th> <th>Tanggal Keluhan</th> <th>Status Keluhan</th> <th>Tanggal Selesai</th> <th>Tools</th> 
    </tr>
 ...
 $nomor = 1;
    while($user_data = mysqli_fetch_array($result)) {         
      ...
      echo "<td>".$user_data['tgl_selesai']."</td>";
        ...
        echo "<td><a class='fas fa-pen-alt' href='edit_penanganan.php?npa=$user_data[npa]'></a> 
        <a class='fas fa-trash-alt' href='delete_penanganan.php?npa=$user_data[npa]'></a></td></tr>";        
    }
