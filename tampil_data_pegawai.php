...
$result = mysqli_query($mysqli, "SELECT * FROM tbl_data_pegawai ORDER BY nipp DESC");
...
<div style ="color: white; font-family:Zapf-Chancery; font-size: 22px;
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
         ...
         <center><h2 class="mb-4" >Data Pegawai</h2></center>
            <br>
       
        <h4></h4>
        <form action="tampil_data_pegawai.php" method="POST">
          <center>
            <div class ="cari">
...
<center>
   <tr>
     <th>No</th> <th>Nipp</th> <th>Nama</th> <th>Golongan</th> <th>Jabatan</th> <th>Masa Bekerja</th> <th>Tools</th>
    </tr>
<?php  

    if(isset($_POST['cari'])){
  $cari = $_POST['cari'];
  $result = mysqli_query($mysqli, "SELECT * FROM tbl_data_pegawai ORDER BY nomor DESC");

$result = mysqli_query($mysqli,"select * from tbl_data_pegawai where nipp like '%".$cari."%'");    
 }else{
  $result = mysqli_query($mysqli,"select * from tbl_data_pegawai");  
 }
 ...
 $nomor = 1;
    ...
    while($user_data = mysqli_fetch_array($result)) {       
        ...
        echo "<td>".$user_data['nipp']."</td>";
        echo "<td>".$user_data['nama']."</td>";
         echo "<td>".$user_data['golongan']."</td>";
         echo "<td>".$user_data['jabatan']."</td>";   
         echo "<td>".$user_data['masa']."</td>";
               
        echo "<td> <a class='fas fa-pen-alt' href='edit_data_pegawai.php?nipp=$user_data[nipp]'></a> 
        <a class='fas fa-trash-alt' href='delete_data_pegawai.php  ?nipp=$user_data[nipp]'></a></td></tr>"; 
    ...
    ?>
         ...
         <link rel="stylesheet" href="css/tampil_pegawai.css">
