...
<div style ="color: white; font-family:Zapf-Chancery; font-size: 22px;
 ...
 <marquee bgcolor="white" style=" font-family:Zapf-Chancery; color: blue; font-size:x-large;transform: translate(-6.45%, 533%)"; width=735px; title="Ini Muncul Saat Hover" behavior="alternate" onmouseover="this.stop()" onmouseout="this.start()"direction="right" >Selamat Datang, Di Sistem  Pengaduan Pelanggan Pdam Tirtanadi Cabang Cemara</a></marquee>
